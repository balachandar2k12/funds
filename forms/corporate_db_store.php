...
// $_POST['account_type'];
// $_POST['applicantname'];
// $_POST['applicantdoidd'];
// $_POST['applicantdoimm'];
// $_POST['applicantdoiyyyy'];
// $_POST['applicantpan'];
// $_POST['applicant2contactname'];
// $_POST['applicant2contactdes'];
// $_POST['applicant2contactemail'];
// $_POST['applicant2contacttelr'];
// $_POST['applicant2contacttelo'];
// $_POST['applicant2contacttelm'];
// $_POST['applicantocc'];
// $_POST['applicantstatus'];
// $_POST['applicanttaxstatus'];
// $_POST['applicantpaddr1'];
// $_POST['applicantpaddr2'];
// $_POST['applicantpaddr3'];
// $_POST['applicantpcity'];
// $_POST['applicantpstate'];
// $_POST['applicantpzip'];
// $_POST['applicantpaddrcheck'];
// $_POST['applicantcaddr1'];
// $_POST['applicantcaddr2'];
// $_POST['applicantcaddr3'];
// $_POST['applicantccity'];
// $_POST['applicantcstate'];
// $_POST['applicantczip'];
// $_POST['applicant2name'];
// $_POST['applicant2pan'];
// $_POST['applicant3name'];
// $_POST['applicant3pan'];
// $_POST['bankname'];
// $_POST['bankacctype'];
// $_POST['bankaccno'];
...
// $_POST['bank3micr'];
// $_POST['bank3ifsc'];
// $_POST['applicantvalidy'];
// $_POST['applicantvalidma'];
// $_POST['appnomname'];
// $_POST['appnomdobd'];
// $_POST['appnomdobm'];
// $_POST['appnomdoby'];
