...
$return_array = array();
  ...
  // load array
	...
	$applicant_account_type = request("account_type", "nri");
	...
	$applicant_nationality= request("applicantnat", "");
	...
	$applicant_address_overseas_country = request("applicantocou", "");
...
//check validation and defaults /formatting
	...
	if($applicant_email==="")
		...
		if($applicant_tax_status==="--Select--")
			$return_attr['applicanttaxstatus']="Please select the Tax Status ";
		else
			$return_attr['applicanttaxstatus']="TRUE";
			
		if($applicant_nationality==="--Select--")
			$return_attr['applicantnat']="Please select the Nationality ";
		else
			$return_attr['applicantnat']="TRUE";
	
	if($applicant_address_overseas_line1==="")
		$return_attr['applicantoaddr1']="address line cannot  be empty";
	else 
		$return_attr['applicantoaddr1']="TRUE";
		
	if($applicant_address_overseas_city==="")
		$return_attr['applicantocity']="city cannot  be empty";
	else 
		$return_attr['applicantocity']="TRUE";
		
	if($applicant_address_overseas_state==="")
		$return_attr['applicantostate']="State cannot  be empty";
	else 
		$return_attr['applicantostate']="TRUE";
		
		if($applicant_address_overseas_country==="--Select--")
			$return_attr['applicantocou']="Please select the country ";
		else
			$return_attr['applicantocou']="TRUE";
			
			
	
	$pinpattern="/^[0-9]{6,7}/";
	
	if($applicant_address_overseas_pincode==="")
		$return_attr['applicantozip']="zip/pincode  cannot be empty";
	else
		if(preg_match($pinpattern,$applicant_address_overseas_pincode))
			$return_attr['applicantozip']="TRUE";
		else
			$return_attr['applicantozip']="In Valid zip/Pincode ";
	
	if($applicant_address_india_line1==="")
		$return_attr['applicantiaddr1']="address cannot  be empty";
	else 
		$return_attr['applicantiaddr1']="TRUE";
		
	if($applicant_address_india_city==="")
		$return_attr['applicanticity']="city cannot  be empty";
	else 
		$return_attr['applicanticity']="TRUE";
		
	if($applicant_address_india_state==="")
		$return_attr['applicantistate']="State cannot  be empty";
	else 
		$return_attr['applicantistate']="TRUE";
	
	if($applicant_address_india_pincode==="")
		$return_attr['applicantizip']="zip/pincode  cannot be empty";
	else
		if(preg_match($pinpattern,$applicant_address_india_pincode))
			$return_attr['applicantizip']="TRUE";
		else
			$return_attr['applicantizip']="In Valid zip/Pincode ";
...
{	
	...
	//prepare sql
  $sql = "INSERT INTO `nri_customer`";
        $sql .= " (";
        $sql .= "nri_customer.applicant_id"; 
        $sql .= ",nri_customer.applicant_account_type"; 
        $sql .= ",nri_customer.applicant_name"; 
        $sql .= ",nri_customer.applicant_father_name"; 
        $sql .= ",nri_customer.applicant_dob"; 
        $sql .= ",nri_customer.applicant_gender"; 
        $sql .= ",nri_customer.applicant_pan"; 
        $sql .= ",nri_customer.applicant_telephone_residence"; 
        $sql .= ",nri_customer.applicant_telephone_office"; 
        $sql .= ",nri_customer.applicant_telephone_mobile"; 
        $sql .= ",nri_customer.applicant_email"; 
        $sql .= ",nri_customer.applicant_occupation"; 
		$sql .= ",nri_customer.applicant_tax_status"; 
		...
		$sql .= ",nri_customer.applicant_bank1_account_number"; 
        $sql .= ",nri_customer.bank1_account_type"; 
        $sql .= ",nri_customer.bank1_ifsc_code"; 
        $sql .= ",nri_customer.bank1_micr_code"; 
        ...
        $sql .= ",nri_customer.bank2_micr_code"; 
        $sql .= ",nri_customer.bank2_name"; 
        $sql .= ",nri_customer.bank2_branch_address_line1"; 
        $sql .= ",nri_customer.bank2_branch_address_line2"; 
        $sql .= ",nri_customer.bank2_branch_city"; 
        $sql .= ",nri_customer.applicant_bank3_account_number"; 
        $sql .= ",nri_customer.bank3_account_type"; 
        $sql .= ",nri_customer.bank3_ifsc_code"; 
        $sql .= ",nri_customer.bank3_micr_code"; 
        $sql .= ",nri_customer.bank3_name"; 
        $sql .= ",nri_customer.bank3_branch_address_line1"; 
        $sql .= ",nri_customer.bank3_branch_address_line2"; 
        $sql .= ",nri_customer.bank3_branch_city"; 
        $sql .= ",nri_customer.applicant_nominee_mandate"; 
        $sql .= ",nri_customer.applicant_nominee_name"; 
        $sql .= ",nri_customer.applicant_nominee_dob"; 
        $sql .= ",nri_customer.applicant_nominee_parent_name"; 
        $sql .= ",nri_customer.applicant_nominee_relationship"; 
        $sql .= ",nri_customer.applicant_sip_mandate"; 
        $sql .= ",nri_customer.applicant_sip_mandate_years"; 
        $sql .= ",nri_customer.appplicant_sip_mandate_maximum_per_month"; 
        $sql .= ") ";
        $sql .= " VALUES "; 
        $sql .= " (";
        $sql .=  "?" ; 
...
$return_array['error'] ='0';
	 /*Prepared statement, sql insert */
	   ...
	   $mysqli2 = new mysqli("localhost", "root","", "fundsinn_db");
		...
		$query="SELECT count(*) FROM `nri_customer` WHERE `applicant_id` like \"".$applicant_id."%\"";
		$genid="0";
