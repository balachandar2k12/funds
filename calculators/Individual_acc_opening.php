...
//form submit ajax option
	...
	function validateindividual(individualform)
	{
		...
		if(!(acceptagreement()))
		{
			$('#agreementaccept').focus();
			return rest;	
		}
	
		
		formres['applicantname']=alphareq(individualform.applicantname.value,'applicantname','instructapplicantname');
		formres['applicantfname']=alphareq(individualform.applicantfname.value,'applicantfname','instructapplicantfname');
		formres['applicantdobdd']=ddval(individualform.applicantdobdd.value,'applicantdobdd','instructapplicantdobdd');
		formres['applicantdobmm']=mmval(individualform.applicantdobmm.value,'applicantdobmm','instructapplicantdobdd');
		formres['applicantdobyyyy']=yyval(individualform.applicantdobyyyy.value,'applicantdobyyyy','instructapplicantdobdd');
		formres['applicantpan']=panval(individualform.applicantpan.value,'applicantpan','instructapplicantpan');
		formres['applicanttelr']=terval(individualform.applicanttelr.value,'applicanttelr','instructapplicanttelr');
		formres['applicanttelo']=teoval(individualform.applicanttelo.value,'applicanttelo','instructapplicanttelo');
		formres['applicanttelm']=temval(individualform.applicanttelm.value,'applicanttelm','instructapplicanttelm');
		formres['applicantemail']=emval(individualform.applicantemail.value,'applicantemail','instructapplicantemail');
		formres['applicantoccselect']=ocval(individualform.applicantocc.value,'applicantocc','instructapplicantocc');
		formres['applicantpaddr1']=addrval(individualform.applicantpaddr1.value,'applicantpaddr1','instructapplicantpaddr');
		formres['applicantpcity']=cityval(individualform.applicantpcity.value,'applicantpcity','instructapplicantpaddr');
		formres['applicantpstate']=stateval(individualform.applicantpstate.value,'applicantpstate','instructapplicantpaddr');
		formres['applicantpzip']=pinval(individualform.applicantpzip.value,'applicantpzip','instructapplicantpaddr');
	
		if(!(individualform.applicantpaddrcheck.checked))
		{
			formres['applicantcaddr1']=addrval(individualform.applicantcaddr1.value,'applicantcaddr1','instructapplicantcaddr');
			formres['applicantccity']=cityval(individualform.applicantccity.value,'applicantccity','instructapplicantcaddr');
			formres['applicantcstate']=stateval(individualform.applicantcstate.value,'applicantcstate','instructapplicantcaddr');
			formres['applicantczip']=pinval(individualform.applicantczip.value,'applicantczip','instructapplicantcaddr');
		}
	
		if(!($('#investor2').is(':hidden')))
		{
				formres['applicant2name']=alphareq(individualform.applicant2name.value,'applicant2name','instructapplicant2name');
				formres['applicant2pan']=panval(individualform.applicant2pan.value,'applicant2pan','instructapplicant2pan');
		}
		if(!($('#investor3').is(':hidden')))
		{
				formres['applicant3name']=alphareq(individualform.applicant3name.value,'applicant3name','instructapplicant3name');
				formres['applicant3pan']=panval(individualform.applicant3pan.value,'applicant3pan','instructapplicant3pan');
		}
	
	
		formres['bankname']=bankval(individualform.bankname.value,'bankname','instructbank');
		formres['bankaccno']=accval(individualform.bankaccno.value,'bankaccno','instructbank');
		formres['bankifsc']=ifscval(individualform.bankifsc.value,'bankifsc','instructbank');
		formres['bankaddr1']=bankaddrval(individualform.bankaddr1.value,'bankaddr1','instructbank');
		formres['bankcity']=cityval(individualform.bankcity.value,'bankcity','instructbank');
		formres['bankmicr']=micrval(individualform.bankmicr.value,'bankmicr','instructbank');
		
		if(!($('#bankdetails2').is(':hidden')))
		{
			formres['bank2name']=bankval(individualform.bank2name.value,'bank2name','instructbank2');
			formres['bank2accno']=accval(individualform.bank2accno.value,'bank2accno','instructbank2');
			formres['bank2ifsc']=ifscval(individualform.bank2ifsc.value,'bank2ifsc','instructbank2');
			formres['bank2addr1']=bankaddrval(individualform.bank2addr1.value,'bank2addr1','instructbank2');
			formres['bank2city']=cityval(individualform.bank2city.value,'bank2city','instructbank2');
			formres['bank2micr']=micrval(individualform.bank2micr.value,'bank2micr','instructbank2');
		}
		
		if(!($('#bankdetails3').is(':hidden')))
		{
			formres['bank3name']=bankval(individualform.bank2name.value,'bank3name','instructbank3');
			formres['bank3accno']=accval(individualform.bank2accno.value,'bank3accno','instructbank3');
			formres['bank3ifsc']=ifscval(individualform.bank2ifsc.value,'bank3ifsc','instructbank3');
			formres['bank3addr1']=bankaddrval(individualform.bank2addr1.value,'bank3addr1','instructbank3');
			formres['bank3city']=cityval(individualform.bank2city.value,'bank3city','instructbank3');
			formres['bank3micr']=micrval(individualform.bank2micr.value,'bank3micr','instructbank3');
		}
		
		
		if(!(individualform.applicantsip.checked))
		{
			formres['applicantvalidy']=vyval(individualform.applicantvalidy.value,'applicantvalidy','instructapplicantsip');
			formres['applicantvalidma']=maval(individualform.applicantvalidma.value,'applicantvalidma','instructapplicantsip');
		}
		if(!(individualform.aplicantnomcheckbox.checked))
		{
			formres['appnomname']=appnominval(individualform.appnomname.value,'appnomname','instructappnomname');
			formres['appnomdobd']=ddval(individualform.appnomdobd.value,'appnomdobd','instructappnomdobd');
			formres['appnomdobm']=mmval(individualform.appnomdobm.value,'appnomdobm','instructappnomdobd');
			formres['appnomdoby']=yyval(individualform.appnomdoby.value,'appnomdoby','instructappnomdobd');
			if(!individualform.appnompname.value=="")
			{
				formres['appnompname']=nomempval(individualform.appnompname.value,'appnompname','instructappnompname');
				formres['appnomrel']=nomemrval(individualform.appnomrel.value,'appnomrel','instructappnomrel');
			}
			if(!individualform.appnomrel.value=="")
			{
				formres['appnompname']=nomempval(individualform.appnompname.value,'appnompname','instructappnompname');
				formres['appnomrel']=nomemrval(individualform.appnomrel.value,'appnomrel','instructappnomrel');
			}
		...
		rest=true;
		$.each(formres, function(index, value) {
				if(value!="TRUE"){
					 var o = $('#'+index).focus().offset().top, $w = $(window);
  ...
  <div class="pageContent">
    ...
    <div class="serviceContainer container_16">
      ...
      <div id="signUp-Container" class="grid_14 gridFirst"> 
       <!-- woofoo forms -->
        <form id="individualform" name="individualform" class="wufoo leftLabel page"  novalidate method="post" action="individual.php">
			<div id="errordis">
		...
		<ul>
            <li class="notranslate">
              ...
              <div>
                <input id="redirectIndividual" <?php 
            ...
            <li class="notranslate">
              ...
              <div>
                <input id="applicantfname" name="applicantfname" type="text" class="field text nospin medium" onChange="alphareq(this.value,'applicantfname','instructapplicantfname')" value="" maxlength="54" tabindex="5"  />
              </div>
...
<![endif]-->
            ...
            <li class="notranslate">
              ...
              <div>
                <input id="applicantemail" class="field text medium" name="applicantemail" tabindex="15" required  onChange="emval(this.value,'applicantemail','instructapplicantemail')" maxlength="37" type="email" value="<?php if($email!="")
			echo $email ?>" />
			 <input id="signupemail" name="signupemail"  maxlength="37" type="hidden" value="<?php if($email!="")
			echo $email ?>" />
            ...
            <li class="notranslate">
              ...
              <div>
                <div class="styled-select">
                  <select  id="applicantoccselect" name="applicantocc" class="field select medium" tabindex="16" onChange="ocval(this.value,'applicantocc','instructapplicantocc')" >
		  ...
		  <diV id="Addinvestorsblock" >
				...
				<div>
                <input id="applicant2name" name="applicant2name" type="text" class="field text medium" onchange="alphareq(this.value,'applicant2name','instructapplicant2name');" value="" maxlength="62" tabindex="27"  required autofocus />
              </div>
             ...
             <div>
                <input id="applicant2pan" class="field text medium" name="applicant2pan" tabindex="28" required onchange="panval(this.value,'applicant2pan','instructapplicant2pan');" type="text" value="" />
              </div>
              ...
              <div>
                <input id="applicant3name" name="applicant3name" type="text" class="field text medium" value="" maxlength="62" onchange="alphareq(this.value,'applicant3name','instructapplicant3name');" tabindex="29"  required autofocus />
              </div>
              ...
              <div>
                <input id="applicant3pan" class="field text medium" name="applicant3pan" tabindex="30" required  onchange="panval(this.value,'applicant3pan','instructapplicant3pan');" type="text" value="" />
              </div>
		   ...
		   <ul id="addinvestorsbutton">
            ...
            <li class="complex notranslate">
              <div id="bank2details"> <span class="full addr1">
			   ...
			   <label>Branch Address</label> <span class="right state">
	  ...
	  <ul>
		 ...
		 <div class="formHeaderTitle">
		   ...
		   function acceptagreement(){
                ...
                <input id="saveForm"  onclick="return validateindividual(this.form);" name="saveForm" class="btTxt submit fundsInn-btn" type="submit" tabindex="69" value="Submit"/>
