...
<script type="text/javascript">
	...
	function slidertog3(selval)
	{
		...
		else
		{
			...
			$.ajax({
					type: "POST",
					url: './ajxdt.php?mfscsel='+selval+'&mfsel='+$('#mutualfsel').val(),
					success: function (data) {
						$("#datesel").html(data);
					}});
  ...
  <div class="pageContent">
    ...
    <div class="serviceContainer container_16" >
      ...
      <div id="signUp-Container" class="grid_14 gridFirst"> 
       <!-- woofoo forms -->
        <form id="sipcalform" name="sipcalform" class="wufoo leftLabel page"  autocomplete="off" novalidate method="post" action="sipcal.php">
			<div id="errordis">
		  ...
		  ?>
           ...
           <div id="mfscheme" hidden>
		    ...
		    <div id="datesel" hidden>
			   ...
			   <li class="buttons ">
              <div>
			       <input id="sipcalForm"  onclick="return validatesip(this.form);" name="sipcalForm" class="btTxt submit fundsInn-btn" type="submit" tabindex="69" value="Submit"/>
              </div>
            </li>
		 </ul>
        </form>
				...
				if(($postmfsel!="0") && ($psotmfscsel!="0") && ($postfrmdate!="0") && ($psottodate!="0") && ($posthashtx!="0"))
				{
					...
					?>
								...
								<table class="table table-striped table-condensed table-hover"> 
										...
										<thead>
													<tr>
													<th><?php echo  $mfname; ?>&nbsp;</th>
													<th><?php echo  $mfscname; ?></th>
												</tr>
												<tr>
													<th>NAV Date&nbsp;&nbsp;&nbsp</th>
													<th>Price &nbsp;&nbsp;</th>
